 ...
 * - Configurable label for context (Thumbnail vs Featured)
 */
...
export const ProjectImageUpload = ({ value, onChange, label = 'Image' }: ProjectImageUploadProps) => {
  ...
  const handleUpload = async (file: File) => {
    ...
    try {
      ...
      const filePath = `projects/${timestamp}-${sanitizedName}`
