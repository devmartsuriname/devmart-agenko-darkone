 ...
 * Handles hero background image uploads to Supabase Storage (media/heroes/)
 */
...
export const HeroImageUpload = ({ value, onChange, label = 'Hero Image' }: HeroImageUploadProps) => {
