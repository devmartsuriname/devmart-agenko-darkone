/**
 * Award Image Upload Component
 * Handles award image uploads to Supabase Storage (media/awards/)
 */
...
interface AwardImageUploadProps {
  value: string | null
  onChange: (url: string | null) => void
  label?: string
}

export const AwardImageUpload = ({ value, onChange, label = 'Award Image' }: AwardImageUploadProps) => {
      ...
      {value ? (
        ...
        >
          ...
          {uploading ? (
            ...
            <>
              <Icon icon="mingcute:upload-2-line" className="fs-1 text-muted mb-2 d-block" />
