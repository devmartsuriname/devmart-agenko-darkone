/**
 * Testimonial Image Upload Component
 * Handles avatar image uploads to Supabase Storage (media/testimonials/)
 */
...
export const TestimonialImageUpload = ({ value, onChange, label = 'Avatar' }: TestimonialImageUploadProps) => {
