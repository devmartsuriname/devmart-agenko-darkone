/**
 * Team Member Image Upload Component
 * Handles avatar image uploads to Supabase Storage (media/team/)
 */
...
export const TeamMemberImageUpload = ({ value, onChange, label = 'Avatar' }: TeamMemberImageUploadProps) => {
