...
const FrontendHomeWhyChoose = lazy(() => import('@/app/(admin)/frontend/sections/home/whychoose/page'))
...
const cmsRoutes: RoutesProps[] = [
  ...
  {
    path: '/frontend/sections/home/whychoose',
    name: 'Frontend - Home WhyChoose',
    element: <FrontendHomeWhyChoose />,
  },
]
